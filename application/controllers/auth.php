...
//				'phone' => $this->input->post('phone1') . '-' . $this->input->post('phone2') . '-' . $this->input->post('phone3'),
  ...
  function register()
  {
    ...
    //validate form input
    $this->form_validation->set_rules('first_name', 'Имя пользователя', 'required|xss_clean');
    $this->form_validation->set_rules('email', 'Адрес электронной почты', 'required|valid_email');
